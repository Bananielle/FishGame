...
class PressSpace(pygame.sprite.Sprite):
    def __init__(self,SCREEN_WIDTH,SCREEN_HEIGHT,PATH):
        ...
        self.PATH = PATH
        self.surf = pygame.image.load(self.PATH + "press_space.png").convert()
...
class Fish(pygame.sprite.Sprite):
    def __init__(self,SCREEN_WIDTH,SCREEN_HEIGHT,PATH):
        ...
        self.SCREEN_HEIGHT = SCREEN_HEIGHT
        self.PATH = PATH
        self.surf = pygame.image.load(self.PATH + "bigfish.png").convert()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        self.rect = self.surf.get_rect()
...
class FishAdventure(pygame.sprite.Sprite):
    def __init__(self,SCREEN_WIDTH,SCREEN_HEIGHT,PATH):
        ...
        self.SCREEN_HEIGHT = SCREEN_HEIGHT
        self.PATH = PATH
        self.surf = pygame.image.load(self.PATH + "fish_adventure.png").convert_alpha()
        self.surf.set_colorkey((0, 0, 0), RLEACCEL)
        self.rect = self.surf.get_rect()
